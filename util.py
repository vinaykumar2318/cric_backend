...
if __name__ == '__main__':
    ...
    print(classify_image(None, "./test_images/virat_kohli2.png"))
    print(classify_image(None, "./test_images/rohit_sharma2.png"))
    print(classify_image(None, "./test_images/ms_dhoni14.png"))
    print(classify_image(None, "./test_images/virat_kohli6.png"))
    print(classify_image(None, "./test_images/kl_rahul6.png"))
    print(classify_image(None, "./test_images/shubhman_gill3.png"))
